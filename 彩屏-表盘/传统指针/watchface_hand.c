...
#define TRIANGLE_BG_SIZE_H			176
#define TRIANGLE_BG_SIZE_W			176

/*中心图片*/
#define TRIANGLE_CENTER_ORIGIN_X		85
#define TRIANGLE_CENTER_ORIGIN_Y		85
#define TRIANGLE_CENTER_SIZE_H			7
#define TRIANGLE_CENTER_SIZE_W			7
