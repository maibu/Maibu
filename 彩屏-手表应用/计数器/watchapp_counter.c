...
#define COUNTER_BG_SIZE_H		176
#define COUNTER_BG_SIZE_W		176

/*文本图层位置*/
#define COUNTER_TEXT_ORIGIN_X		0	
#define COUNTER_TEXT_ORIGIN_Y		66	
#define COUNTER_TEXT_SIZE_H		42
#define COUNTER_TEXT_SIZE_W		176

/*文本1图层位置*/
#define COUNTER_TEXT1_ORIGIN_X		0	
#define COUNTER_TEXT1_ORIGIN_Y		148
#define COUNTER_TEXT1_SIZE_H		16
#define COUNTER_TEXT1_SIZE_W		176
...
/*--------添加图片图层------------*/
	...
	app_layer_set_bg_color(layer_bmp, GColorBlack);
...
/*---------添加显示文本图层---------------*/
	...
	char text[6] = "";
	sprintf(text, "%d", g_count_index);
	LayerText lt = {text, frame_text, GAlignTop, GColorBlack, U_ASCII_ARIAL_42};

	/*创建文本图层*/
	P_Layer layer_text = app_layer_create_text(&lt);
	app_layer_set_bg_color(layer_text, GColorWhite);
...
/*---------添加显示文本图层---------------*/
	...
	LayerText lt1 = {text1, frame1_text, GAlignTop, GColorWhite, U_GBK_SIMSUN_16};
