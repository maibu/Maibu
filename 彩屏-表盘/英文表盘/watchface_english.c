...
#define ENGLISH_BG_SIZE_H		176
#define ENGLISH_BG_SIZE_W		176

/*显示小时文本图层*/
#define ENGLISH_H_ORIGIN_X		11
#define ENGLISH_H_ORIGIN_Y		26
#define ENGLISH_H_SIZE_H		42	
#define ENGLISH_H_SIZE_W		165

/*显示分钟十位文本图层*/
#define ENGLISH_M1_ORIGIN_X		11
#define ENGLISH_M1_ORIGIN_Y		70
#define ENGLISH_M1_SIZE_H		42
#define ENGLISH_M1_SIZE_W		165

/*显示分钟个位文本图层*/
#define ENGLISH_M2_ORIGIN_X		11
#define ENGLISH_M2_ORIGIN_Y		114
#define ENGLISH_M2_SIZE_H		30
#define ENGLISH_M2_SIZE_W		165
...
P_Window init_english_window()
{
	...
	display_target_layerText(p_window,&frame_bg,GAlignLeft,GColorBlack,str_hour,U_ASCII_ARIALBD_42,GColorWhite);
	...
	display_target_layerText(p_window,&frame_bg,GAlignLeft,GColorBlack,str_hour,U_ASCII_ARIALBD_30,GColorWhite);
	...
	if ((t.min > 20)&&((t.min%10) != 0))
	{
		...
		display_target_layerText(p_window,&frame_bg,GAlignLeft,GColorBlack,str_hour,U_ASCII_ARIAL_30,GColorWhite);
