...
static uint8_t ORIGIN_X[5] = {0, 26, 70, 26, 70};
static uint8_t ORIGIN_Y[5] = {0, 4, 4, 70, 70};
static uint8_t ORIGIN_H[5] = {128, 54, 54, 54, 54};
static uint8_t ORIGIN_W[5] = {128, 32, 32, 32, 32};
