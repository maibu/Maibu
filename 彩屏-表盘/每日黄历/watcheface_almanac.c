...
#define ALMANAC_BG_SIZE_H			176
#define ALMANAC_BG_SIZE_W			176	

/*日期周文本图层位置*/
#define ALMANAC_DAY_ORIGIN_X		25		
#define ALMANAC_DAY_ORIGIN_Y		6
#define ALMANAC_DAY_SIZE_H			16
#define ALMANAC_DAY_SIZE_W			128

/*时间图片图层起始位置*/
#define ALMANAC_TIME_ORIGIN_X		32
#define ALMANAC_TIME_ORIGIN_Y		37
#define ALMANAC_TIME_SIZE_H			47
#define ALMANAC_TIME_SIZE_W			26

/*农历文本图层位置*/
#define ALMANAC_M_D_W_ORIGIN_X		2
#define ALMANAC_M_D_W_ORIGIN_Y		96
#define ALMANAC_M_D_W_SIZE_H		16	
#define ALMANAC_M_D_W_SIZE_W		174

/*农历宜文本图层位置*/
#define ALMANAC_PROPER_DO_ORIGIN_X		51	
#define ALMANAC_PROPER_DO_ORIGIN_Y		125
#define ALMANAC_PROPER_DO_SIZE_H		16
#define ALMANAC_PROPER_DO_SIZE_W		119	

/*农历忌文本图层位置*/
#define ALMANAC_TABOO_ORIGIN_X		51
#define ALMANAC_TABOO_ORIGIN_Y		153
#define ALMANAC_TABOO_SIZE_H		16
#define ALMANAC_TABOO_SIZE_W		119
...
P_Window init_window(void)
{
	...
	display_target_layer(p_window,&temp_frame,GAlignCenter,GColorBlack,bmp_array_name,10);
	...
	display_target_layerText(p_window,&temp_frame,GAlignCenter,GColorWhite,g_almanac_str_ymd,U_ASCII_ARIAL_16,GColorBlack);
	...
	for(ii = 0;ii <=3 ;ii++)
	{
		display_target_layer(p_window,&temp_frame,GAlignLeft,GColorBlack,bmp_array_name,g_time_bmp_num[ii]);
		temp_frame.origin.x = temp_frame.origin.x + 26;
		if(ii == 1)
		{
			temp_frame.origin.x = temp_frame.origin.x + 12;
		}
	}
	...
	display_target_layerText(p_window,&temp_frame,GAlignCenter,GColorBlack,g_almanac_str_lunar,U_ASCII_ARIAL_16,GColorWhite);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorWhite,g_almanac_str_proper,U_ASCII_ARIAL_16,GColorBlack);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorWhite,g_almanac_str_taboo,U_ASCII_ARIAL_16,GColorBlack);
