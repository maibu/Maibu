...
#define MEMORIAL_DAY_BG_SIZE_H				176
#define MEMORIAL_DAY_BG_SIZE_W				176

/*时间文本图层位置*/
#define MEMORIAL_DAY_TIME_ORIGIN_X			118
#define MEMORIAL_DAY_TIME_ORIGIN_Y			2
#define MEMORIAL_DAY_TIME_SIZE_H			16
#define MEMORIAL_DAY_TIME_SIZE_W			55

/*月日文本图层位置*/
#define MEMORIAL_DAY_MONTHDAY_ORIGIN_X		2
#define MEMORIAL_DAY_MONTHDAY_ORIGIN_Y		2
#define MEMORIAL_DAY_MONTHDAY_SIZE_H		16
#define MEMORIAL_DAY_MONTHDAY_SIZE_W		55

/*主倒计日文本图层位置*/
#define MEMORIAL_DAY_MAIN_STR_ORIGIN_X		3
#define MEMORIAL_DAY_MAIN_STR_ORIGIN_Y		30
#define MEMORIAL_DAY_MAIN_STR_SIZE_H		16
#define MEMORIAL_DAY_MAIN_STR_SIZE_W		170

/*主倒计日天数图层起始位置*/
#define MEMORIAL_DAY_DAYSNUMBER_ORIGIN_X	3	
#define MEMORIAL_DAY_DAYSNUMBER_ORIGIN_Y	50
#define MEMORIAL_DAY_DAYSNUMBER_SIZE_H		42
#define MEMORIAL_DAY_DAYSNUMBER_SIZE_W		NULL 

/*主倒计日天数文本"天"图层起始位置*/
#define MEMORIAL_DAY_DAYSTIAN_ORIGIN_X		NULL	
#define MEMORIAL_DAY_DAYSTIAN_ORIGIN_Y		70
#define MEMORIAL_DAY_DAYSTIAN_SIZE_H		16
#define MEMORIAL_DAY_DAYSTIAN_SIZE_W		22

/*次倒计日文本图层位置*/
#define MEMORIAL_DAY_SECONDARY_STR_ORIGIN_X			3
#define MEMORIAL_DAY_SECONDARY_STR_ORIGIN_Y			107
#define MEMORIAL_DAY_SECONDARY_STR_SIZE_H			16
#define MEMORIAL_DAY_SECONDARY_STR_SIZE_W			170

/*次倒计日天数图层起始位置*/
#define MEMORIAL_DAY_SECONDARY_DAYSNUMBER_ORIGIN_X	3
#define MEMORIAL_DAY_SECONDARY_DAYSNUMBER_ORIGIN_Y	126
#define MEMORIAL_DAY_SECONDARY_DAYSNUMBER_SIZE_H	42
#define MEMORIAL_DAY_SECONDARY_DAYSNUMBER_SIZE_W	NULL 

/*次倒计日天数文本"天"图层起始位置*/
#define MEMORIAL_DAY_SECONDARY_DAYSTIAN_ORIGIN_X	NULL	
#define MEMORIAL_DAY_SECONDARY_DAYSTIAN_ORIGIN_Y	147
#define MEMORIAL_DAY_SECONDARY_DAYSTIAN_SIZE_H		16
#define MEMORIAL_DAY_SECONDARY_DAYSTIAN_SIZE_W		22
...
P_Window init_window(void)
{
	...
	display_target_layer(p_window,&temp_frame,GAlignLeft,GColorBlack,RES_BITMAP_WATCHAPP_MEMORIAL_DAY_BG);
	...
	display_target_layerText(p_window,&temp_frame,GAlignRight,GColorBlack,buf,U_ASCII_ARIAL_16,GColorWhite);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorBlack,buf,U_ASCII_ARIAL_16,GColorWhite);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorBlack,g_info_pack[0].show_str,U_ASCII_ARIAL_16,GColorWhite);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorBlack,g_info_pack[0].days_value,U_ASCII_ARIALBD_42,GColorWhite);

	temp_frame.origin.x = MEMORIAL_DAY_DAYSNUMBER_ORIGIN_X+g_info_pack[0].g_days_tian_width+2;
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorBlack,g_tian_str,U_ASCII_ARIAL_16,GColorWhite);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorWhite,g_info_pack[1].show_str,U_ASCII_ARIAL_16,GColorBlack);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorWhite,g_info_pack[1].days_value,U_ASCII_ARIALBD_42,GColorBlack);

	temp_frame.origin.x = MEMORIAL_DAY_SECONDARY_DAYSNUMBER_ORIGIN_X+g_info_pack[1].g_days_tian_width+2;
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorWhite,g_tian_str,U_ASCII_ARIAL_16,GColorBlack);
...
void data_time_handler(char *p,str_day_info *temp_info_pack_p)
{
	...
	if(num_j == 3)
	{
		...
		if((datetime_memorial_day.year < 1970)||(datetime_memorial_day.year > 2080))
		{
			...
			temp_info_pack_p ->g_days_tian_width = strlen(temp_info_pack_p->days_value)*23;
