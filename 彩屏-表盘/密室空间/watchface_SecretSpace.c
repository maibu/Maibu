...
static uint8_t ORIGIN_X[LAYER_NUM+BACKGROUND_NUM] = {0, 4, 45, 86, 127, 4, 45, 86, 127, 4, 45, 86, 127};
static uint8_t ORIGIN_Y[LAYER_NUM+BACKGROUND_NUM] = {0, 1, 1, 1, 1, 59, 59, 59, 59, 117, 117, 117, 117};
static uint8_t ORIGIN_W[LAYER_NUM+BACKGROUND_NUM] = {176, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42};
static uint8_t ORIGIN_H[LAYER_NUM+BACKGROUND_NUM] = {176, 59, 59, 59, 59, 59, 59, 59, 59, 59, 59, 59, 59};
