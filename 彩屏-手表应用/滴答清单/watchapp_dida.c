...
#define LAYER_BG_ORIGIN_Y		22
#define LAYER_BG_SIZE_H			154
#define LAYER_BG_SIZE_W			176

/*菜单图层*/
#define LAYER_MENU_ORIGIN_X		0
#define LAYER_MENU_ORIGIN_Y		22
#define LAYER_MENU_SIZE_H		154
#define LAYER_MENU_SIZE_W		176

/*菜单项*/
#define MENU_ITEM_ORIGIN_X		0
#define MENU_ITEM_ORIGIN_Y		0
#define MENU_ITEM_SIZE_H		45
#define MENU_ITEM_SIZE_W		176

/*菜单项图片元素*/
#define  MENU_ELEMENT_BMP_ORIGIN_X 		2
#define  MENU_ELEMENT_BMP_ORIGIN_Y		8
#define  MENU_ELEMENT_BMP_SIZE_H 		28
#define  MENU_ELEMENT_BMP_SIZE_W		28

/*菜单项标题元素*/
#define  MENU_ELEMENT_TITLE_ORIGIN_X 	34
#define  MENU_ELEMENT_TITLE_ORIGIN_Y	4
#define  MENU_ELEMENT_TITLE_SIZE_H 		20
#define  MENU_ELEMENT_TITLE_SIZE_W		142

/*菜单项日期元素*/
#define  MENU_ELEMENT_DATE_ORIGIN_X 	34
#define  MENU_ELEMENT_DATE_ORIGIN_Y		26
#define  MENU_ELEMENT_DATE_SIZE_H 		16
#define  MENU_ELEMENT_DATE_SIZE_W		142
...
P_Layer create_layer_dida_menu(void)
{
		...
		for (i = 0; i < TASK_LIST_MAX_SIZE; i++)
	{
		...
		element.font = U_GBK_SIMSUN_20;
		element.foregroundColor = GColorBlack;
		app_layer_add_multi_menu_element(&item, &element);
	...
	app_layer_set_bg_color(menu_layer, GColorWhite);
...
static P_Window create_window_dida()
{
	...
	GBitmap bitmap_bg;
	res_get_user_bitmap(RES_BITMAP_WATCHAPP_DIDA_BG, &bitmap_bg);
