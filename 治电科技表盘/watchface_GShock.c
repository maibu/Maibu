...
static uint8_t ORIGIN_X[LAYER_NUM+BACKGROUND_NUM] = {0, 83, 94,107, 117, 4, 30, 30, 45,67, 82,100, 111};
static uint8_t ORIGIN_Y[LAYER_NUM+BACKGROUND_NUM] = {0, 54, 54, 54,  54,54, 70, 77, 77, 77, 77, 89, 89};
