...
static uint8_t ORIGIN_X[LAYER_NUM+BACKGROUND_NUM] = {0, 13, 23, 33, 43, 58, 68, 78, 88, 103, 113, 103};
static uint8_t ORIGIN_Y[LAYER_NUM+BACKGROUND_NUM] = {0, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 91};
static uint8_t ORIGIN_W[LAYER_NUM+BACKGROUND_NUM] = {128, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 16};
static uint8_t ORIGIN_H[LAYER_NUM+BACKGROUND_NUM] = {128, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 10};
