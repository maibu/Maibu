...
#define TIME_NUM 5 //时间位数

/*图片坐标：第一项为背景图片，后面依次为时间的1~4位*/
static uint8_t ORIGIN_X[6] = {0, 39, 62, 97, 120, 0};
static uint8_t ORIGIN_Y[6] = {122, 128, 128, 128, 128, 0};
static uint8_t ORIGIN_H[6] = {54, 41, 41, 41, 41, 122};
static uint8_t ORIGIN_W[6] = {176, 23, 23, 23, 23, 176};


/*图片名数组：第一项为背景图片，后面依次为数字0~9图片*/
uint16_t bmp_array[14] = {PIC_0_1, PIC_1_1, PIC_2_1, PIC_3_1, PIC_4_1, PIC_5_1, PIC_6_1, PIC_7_1, PIC_8_1, PIC_9_1, PIC_1, PIC_2, PIC_3, PIC_4};


/*小时分钟月日图层ID，通过该图层ID获取图层句柄*/
static int8_t g_layer_time[TIME_NUM] ={ -1, -1, -1, -1, -1};

/*窗口ID, 通过该窗口ID获取窗口句柄*/
static int32_t g_window = -1;

/*当前表盘应显示时间*/
static int8_t watch_data[TIME_NUM] = {0,0,0,0,0};
...
static void app_watch_data()
{
	...
	watch_data[4] = (watch_data[4]+1)%4+10;
}
