...
#define WATCHFACE_FACE_BMP_ORIGIN_Y 	0
#define WATCHFACE_FACE_BMP_WIZE_H		176
#define WATCHFACE_FACE_BMP_SIZE_W 		176

#define WATCHFACE_STYLE_1_TIME_HOUR1_ORIGIN_X 	4
#define WATCHFACE_STYLE_1_TIME_HOUR1_ORIGIN_Y 	4
#define WATCHFACE_STYLE_1_TIME_HOUR1_WIZE_H		22
#define WATCHFACE_STYLE_1_TIME_HOUR1_SIZE_W 	12


#define WATCHFACE_STYLE_1_TIME_HOUR2_ORIGIN_X 	18
#define WATCHFACE_STYLE_1_TIME_HOUR2_ORIGIN_Y 	4
#define WATCHFACE_STYLE_1_TIME_HOUR2_WIZE_H		22
#define WATCHFACE_STYLE_1_TIME_HOUR2_SIZE_W 	12

#define WATCHFACE_STYLE_1_TIME_MIN1_ORIGIN_X 	54
#define WATCHFACE_STYLE_1_TIME_MIN1_ORIGIN_Y 	4
#define WATCHFACE_STYLE_1_TIME_MIN1_WIZE_H		22
#define WATCHFACE_STYLE_1_TIME_MIN1_SIZE_W 		12

#define WATCHFACE_STYLE_1_TIME_MIN2_ORIGIN_X 	68
#define WATCHFACE_STYLE_1_TIME_MIN2_ORIGIN_Y 	4
#define WATCHFACE_STYLE_1_TIME_MIN2_WIZE_H		22
#define WATCHFACE_STYLE_1_TIME_MIN2_SIZE_W 		12


#define WATCHFACE_STYLE_2_TIME_HOUR1_ORIGIN_X 	50
#define WATCHFACE_STYLE_2_TIME_HOUR1_ORIGIN_Y 	28
#define WATCHFACE_STYLE_2_TIME_HOUR1_WIZE_H		22
#define WATCHFACE_STYLE_2_TIME_HOUR1_SIZE_W 	12


#define WATCHFACE_STYLE_2_TIME_HOUR2_ORIGIN_X 	64
#define WATCHFACE_STYLE_2_TIME_HOUR2_ORIGIN_Y 	28
#define WATCHFACE_STYLE_2_TIME_HOUR2_WIZE_H		22
#define WATCHFACE_STYLE_2_TIME_HOUR2_SIZE_W 	12

#define WATCHFACE_STYLE_2_TIME_MIN1_ORIGIN_X 	101
#define WATCHFACE_STYLE_2_TIME_MIN1_ORIGIN_Y 	28
#define WATCHFACE_STYLE_2_TIME_MIN1_WIZE_H		22
#define WATCHFACE_STYLE_2_TIME_MIN1_SIZE_W 		12

#define WATCHFACE_STYLE_2_TIME_MIN2_ORIGIN_X 	115
#define WATCHFACE_STYLE_2_TIME_MIN2_ORIGIN_Y 	28
#define WATCHFACE_STYLE_2_TIME_MIN2_WIZE_H		22
#define WATCHFACE_STYLE_2_TIME_MIN2_SIZE_W 		12


#define WATCHFACE_STYLE_1_TEXT_ORIGIN_X 	33
#define WATCHFACE_STYLE_1_TEXT_ORIGIN_Y 	4
#define WATCHFACE_STYLE_1_TEXT_WIZE_H		24
#define WATCHFACE_STYLE_1_TEXT_SIZE_W 		77

#define WATCHFACE_STYLE_2_TEXT_ORIGIN_X 	29
#define WATCHFACE_STYLE_2_TEXT_ORIGIN_Y 	28
#define WATCHFACE_STYLE_2_TEXT_WIZE_H		24
#define WATCHFACE_STYLE_2_TEXT_SIZE_W 		120


#define WATCHFACE_STYLE_1_WORDS_TEXT_ORIGIN_X 	4
#define WATCHFACE_STYLE_1_WORDS_TEXT_ORIGIN_Y 	28
#define WATCHFACE_STYLE_1_WORDS_TEXT_WIZE_H		24
#define WATCHFACE_STYLE_1_WORDS_TEXT_SIZE_W 	124

#define WATCHFACE_STYLE_2_WORDS_TEXT_ORIGIN_X 	0
#define WATCHFACE_STYLE_2_WORDS_TEXT_ORIGIN_Y 	4
#define WATCHFACE_STYLE_2_WORDS_TEXT_WIZE_H		20
#define WATCHFACE_STYLE_2_WORDS_TEXT_SIZE_W 	176
...
static P_Window init_window(void)
{
	...
	/*创建背景图层*/
	display_target_layer(p_window,&bmp_origin_size_bg,GAlignCenter,GColorBlack,get_bmp_icon_key,watch_data[4]);

	display_target_layer(p_window,&bmp_origin_size[watch_data[5] + 8],GAlignLeft,GColorBlack,get_bmp_icon_key,watch_data[5] + 8);
	
	/*创建时分图层*/
	uint8_t i = 0;
	for(i = 0;i <= 3;i++)
	{
		display_target_layer(p_window,&bmp_origin_size[watch_data[5]*4 + i],GAlignLeft,GColorBlack,get_number_icon_key,watch_data[i]);
	}
	...
	if(watch_data[5] == 0)
	{
		...
		display_target_layerText(p_window,&bmp_origin_size[10],GAlignLeft,GColorWhite,str,U_ASCII_ARIAL_20,GColorBlack);

		memset(str,0,sizeof(str));
		memcpy(str,&(text_array[watch_data[6]][sizeof(str)-1]),6);

		GRect temp_bmp_origin_size = bmp_origin_size[10];
		temp_bmp_origin_size.origin.y = temp_bmp_origin_size.origin.y + 22;
		
		display_target_layerText(p_window,&temp_bmp_origin_size,GAlignLeft,GColorWhite,str,U_ASCII_ARIAL_20,GColorBlack);
	...
	else
	{
		...
		display_target_layerText(p_window,&bmp_origin_size[11],GAlignCenter,GColorWhite,text_array[watch_data[6]],U_ASCII_ARIAL_20,GColorBlack);
