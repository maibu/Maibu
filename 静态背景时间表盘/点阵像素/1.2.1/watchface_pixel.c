...
static uint8_t ORIGIN_X[5] = {0, 16, 38, 70, 92};
static uint8_t ORIGIN_Y[5] = {0, 46, 46, 46, 46};
static uint8_t ORIGIN_H[5] = {128, 37, 37, 37, 37};
static uint8_t ORIGIN_W[5] = {128, 22, 22, 22, 22};
