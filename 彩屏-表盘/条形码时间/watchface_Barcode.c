...
static uint8_t ORIGIN_X[LAYER_NUM+BACKGROUND_NUM] = {0, 19, 31, 45, 60, 80, 94, 108, 120, 142, 154, 142};
static uint8_t ORIGIN_Y[LAYER_NUM+BACKGROUND_NUM] = {0, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 125};
static uint8_t ORIGIN_W[LAYER_NUM+BACKGROUND_NUM] = {176, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 22};
static uint8_t ORIGIN_H[LAYER_NUM+BACKGROUND_NUM] = {176, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 14};


/*图片名数组：分别为大数字0~9图片和小数字0~9图片*/
uint16_t bmp_array[12] = {PIC_0_1, PIC_1_1, PIC_2_1, PIC_3_1, PIC_4_1, PIC_5_1, PIC_6_1, PIC_7_1, PIC_8_1, PIC_9_1, PIC_10_1, PIC_11_1};
...
static void app_watch_data()
{
	...
	watch_data[8] = percent%100/10;
	watch_data[9] = percent%10;
