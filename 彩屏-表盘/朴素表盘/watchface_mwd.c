...
#define MWD_BG_SIZE_H		176
#define MWD_BG_SIZE_W		176

/*显示小时分钟文本图层*/
#define MWD_HM_ORIGIN_X		12
#define MWD_HM_ORIGIN_Y		121
#define MWD_HM_SIZE_H		42	
#define MWD_HM_SIZE_W		164

/*显示周月日文本图层*/
#define MWD_WMD_ORIGIN_X	12
#define MWD_WMD_ORIGIN_Y	90
#define MWD_WMD_SIZE_H		20
#define MWD_WMD_SIZE_W		164
...
P_Window init_mwd_window()
{
	...
	LayerText lt_hm = {time_str, frame_hm, GAlignTopLeft, GColorWhite, U_ASCII_ARIALBD_42, 0};
	...
	LayerText lt_wmd = { time_str,frame_wmd, GAlignLeft, GColorWhite, U_ASCII_ARIAL_20, 0};
