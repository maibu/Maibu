...
#define SPORT_BG_SIZE_H			176
#define SPORT_BG_SIZE_W			176

/*显示时间文本图层*/
#define SPORT_HM_ORIGIN_X		8
#define SPORT_HM_ORIGIN_Y	 	11
#define SPORT_HM_SIZE_H			30
#define SPORT_HM_SIZE_W			108

/*显示步数文本图层*/
#define SPORT_STEP_ORIGIN_X		25
#define SPORT_STEP_ORIGIN_Y		100
#define SPORT_STEP_SIZE_H		30
#define SPORT_STEP_SIZE_W		108

/*显示楼层文本图层*/
#define SPORT_FLOOR_ORIGIN_X	61
#define SPORT_FLOOR_ORIGIN_Y	137
#define SPORT_FLOOR_SIZE_H		30
#define SPORT_FLOOR_SIZE_W		72
...
P_Window init_sport_window()
{
	...
	{
		//app_layer_set_bg_color(layer_bitmap_bg, GColorBlack);
	...
	display_target_layerText(p_window,&temp_frame,GAlignLeft,GColorBlack,buff_str,U_ASCII_ARIALBD_30,GColorWhite);
	...
	display_target_layerText(p_window,&temp_frame,GAlignRight,GColorBlack,buff_str,U_ASCII_ARIALBD_30,GColorWhite);	
