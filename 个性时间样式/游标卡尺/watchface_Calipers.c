...
static uint8_t ORIGIN_X[LAYER_NUM+BACKGROUND_NUM] = {0, 12, 12, 80};
static uint8_t ORIGIN_Y[LAYER_NUM+BACKGROUND_NUM] = {0, 9, 69, 3};
static uint8_t ORIGIN_W[LAYER_NUM+BACKGROUND_NUM] = {128, 56, 56, 36};
static uint8_t ORIGIN_H[LAYER_NUM+BACKGROUND_NUM] = {128, 50, 50, 112};
...
static void app_watch_data()
{
	...
	watch_data[2] = 112-datetime.min/5*10;
