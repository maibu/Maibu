...
static uint8_t ORIGIN_X[5] = {0, 35, 48, 67, 80};
static uint8_t ORIGIN_Y[5] = {0, 18, 18, 18, 18};
static uint8_t ORIGIN_H[5] = {128, 22, 22, 22, 22};
static uint8_t ORIGIN_W[5] = {128, 13, 13, 13, 13};
