...
#define TIMER_SET_TOP_TIME_SIZE_H		20
...
#define TIMER_HINT_TEXT2_SIZE_H		20
...
#define TIMER_HINT_TEXT3_SIZE_H		20
...
/*--------添加状态栏显示时间-------*/
	...
	if (g_timer_sec == -1)
	{
		...
		display_target_layerText(p_window,&frame_bmp,GAlignCenter,GColorWhite,"分钟",U_ASCII_ARIALBD_20,GColorBlack);
		...
		display_target_layerText(p_window,&frame_bmp,GAlignCenter,GColorWhite,"请选择计时时长",U_ASCII_ARIALBD_20,GColorBlack);
	...
	else if (g_timer_sec > 0)
	{
		...
		display_target_layerText(p_window,&frame_bmp,GAlignCenter,GColorWhite,text,U_ASCII_ARIALBD_20,GColorBlack);
	...
	g_timer_set_top_time_layer_id = display_target_layerText(p_window,&frame_bmp,GAlignCenter,GColorWhite,text,U_ASCII_ARIAL_20,GColorBlack);
