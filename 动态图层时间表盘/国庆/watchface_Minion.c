...
static uint8_t ORIGIN_X[6] = {4, 28, 45, 70, 87, 6};
static uint8_t ORIGIN_Y[6] = {88, 93, 93, 93, 93, 0};
static uint8_t ORIGIN_H[6] = {38, 30, 30, 30, 30, 88};
static uint8_t ORIGIN_W[6] = {120, 17, 17, 17, 17, 115};
