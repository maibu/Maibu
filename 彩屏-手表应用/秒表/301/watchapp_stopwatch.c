...
/*背景图层位置*/
#define STOPWATCH_BG_ORIGIN_X		0	
#define STOPWATCH_BG_ORIGIN_Y		0
#define STOPWATCH_BG_SIZE_H			176
#define STOPWATCH_BG_SIZE_W			176	


/*时间图层位置*/
#define STOPWATCH_TIME_ORIGIN_X			0	
#define STOPWATCH_TIME_ORIGIN_Y			0
#define STOPWATCH_TIME_SIZE_H			20	
#define STOPWATCH_TIME_SIZE_W			143


/*上面分秒图层位置*/
#define STOPWATCH_TOP_MIN_SEC_ORIGIN_X			2	
#define STOPWATCH_TOP_MIN_SEC_ORIGIN_Y			22
#define STOPWATCH_TOP_MIN_SEC_SIZE_H			42	
#define STOPWATCH_TOP_MIN_SEC_SIZE_W			110


/*上面毫秒图层位置*/
#define STOPWATCH_TOP_MICRO_ORIGIN_X		112	
#define STOPWATCH_TOP_MICRO_ORIGIN_Y		25
#define STOPWATCH_TOP_MICRO_SIZE_H			20	
#define STOPWATCH_TOP_MICRO_SIZE_W			32	

/*侧边栏图层位置*/
#define STOPWATCH_SIDE_BG_ORIGIN_X		143
#define STOPWATCH_SIDE_BG_ORIGIN_Y		0
#define STOPWATCH_SIDE_BG_SIZE_H			176
#define STOPWATCH_SIDE_BG_SIZE_W			33	


/*开始/暂停图层位置*/
#define STOPWATCH_SIDE_PLAY_ORIGIN_X		149	
#define STOPWATCH_SIDE_PLAY_ORIGIN_Y		77
#define STOPWATCH_SIDE_PLAY_SIZE_H			22
#define STOPWATCH_SIDE_PLAY_SIZE_W			22	


/*第一个记录图层位置*/
#define STOPWATCH_RECORD1_ORIGIN_X		4	
#define STOPWATCH_RECORD1_ORIGIN_Y		64
#define STOPWATCH_RECORD1_SIZE_H			20	
#define STOPWATCH_RECORD1_SIZE_W			139	


/*第二个记录图层位置*/
#define STOPWATCH_RECORD2_ORIGIN_X		4	
#define STOPWATCH_RECORD2_ORIGIN_Y		86
#define STOPWATCH_RECORD2_SIZE_H			20	
#define STOPWATCH_RECORD2_SIZE_W			139

/*第三个记录图层位置*/
#define STOPWATCH_RECORD3_ORIGIN_X		4	
#define STOPWATCH_RECORD3_ORIGIN_Y		108
#define STOPWATCH_RECORD3_SIZE_H			20	
#define STOPWATCH_RECORD3_SIZE_W			139	

/*第四个记录图层位置*/
#define STOPWATCH_RECORD4_ORIGIN_X		4	
#define STOPWATCH_RECORD4_ORIGIN_Y		130
#define STOPWATCH_RECORD4_SIZE_H			20	
#define STOPWATCH_RECORD4_SIZE_W			139

/*第五个记录图层位置*/
#define STOPWATCH_RECORD5_ORIGIN_X		4	
#define STOPWATCH_RECORD5_ORIGIN_Y		152
#define STOPWATCH_RECORD5_SIZE_H			20	
#define STOPWATCH_RECORD5_SIZE_W			139
...
/*开始背景图层ID*/
static int8_t g_stopwatch_side_bg_layer_id = -1;
...
int32_t bmp_array_name [] = 
{
	...
	RES_BITMAP_WATCHAPP_STOPWATCH_SIDE_BG1_BMP,
	RES_BITMAP_WATCHAPP_STOPWATCH_BG_BMP
};
...
/*创建并显示文本图层*/
P_Layer display_target_layerText(GRect  *temp_p_frame,enum GAlign how_to_align,char * str,uint8_t font_type,enum GColor color,enum GColor fcolor)
{
...
P_Layer stopwatch_create_sec_micro_layer()
{
	...
	P_Layer micro_layer = display_target_layerText(&micro_frame,GAlignCenter,micro_buf,U_ASCII_ARIAL_20,GColorWhite,GColorBlack);
...
P_Layer stopwatch_create_hour_min_sec_layer()
{
	...
	P_Layer hour_min_sec_layer = display_target_layerText(&hour_min_sec_frame,GAlignCenter,sec_buf,U_ASCII_ARIAL_42,GColorWhite,GColorBlack);
...
P_Layer stopwatch_create_record_text_layer(int8_t index)
{
	...
	/*添加图层*/
	GRect record_frame = {{STOPWATCH_RECORD1_ORIGIN_X, STOPWATCH_RECORD1_ORIGIN_Y + index * 20}, 
	...
	P_Layer record_layer = display_target_layerText(&record_frame,GAlignLeft,buf,U_ASCII_ARIAL_20,GColorWhite,GColorBlack);
...
static void stopwatch_select_select(void *context)
{
	...
	if (NULL != p_window)
	{
		...
		if(0 == g_stopwatch.state)
		{
			...
			p_side_play_layer = app_window_get_layer_by_id(p_window, g_stopwatch_side_bg_layer_id);
...
P_Window stopwatch_create_init_window()
{
	...
	/*添加背景图层*/
	GRect bg_frame = {{STOPWATCH_BG_ORIGIN_X, STOPWATCH_BG_ORIGIN_Y}, 
						{ STOPWATCH_BG_SIZE_H, STOPWATCH_BG_SIZE_W}};
	
	P_Layer	 bg_layer = display_target_layer(&bg_frame,GAlignCenter,bmp_array_name,3);
	...
	P_Layer time_layer = display_target_layerText(&time_frame,GAlignCenter,buf,U_ASCII_ARIAL_20,GColorWhite,GColorBlack);
	...
	side_bg_layer = display_target_layer(&side_bg_frame,GAlignCenter,bmp_array_name,2);
	...
	{
		maibu_layer_set_visible_status(side_bg_layer, true);
		maibu_layer_set_visible_status(side_play_pause_layer, false);
	}
	else
	{
		maibu_layer_set_visible_status(side_bg_layer, false);
	...
	g_stopwatch_side_bg_layer_id = app_window_add_layer(p_window, side_bg_layer);
