...
static P_Window init_window(void)
{
	...
	temp_origin_size.origin = eye_origin[datetime.hour%12]; 
	...
	temp_origin_size.origin.x = eye_origin[datetime.hour%12].x + WATCHFACE_EYE_MIN1_ORIGIN_X; 
	temp_origin_size.origin.y = eye_origin[datetime.hour%12].y + WATCHFACE_EYE_MIN1_ORIGIN_Y; 
	temp_origin_size.size.h = WATCHFACE_EYE_MIN1_SIZE_H;
	temp_origin_size.size.w = WATCHFACE_EYE_MIN1_SIZE_W;

	display_target_layer(p_window,&temp_origin_size,GAlignCenter,GColorWhite,get_number_icon_key[datetime.min/10]);

	temp_origin_size.origin.x = eye_origin[datetime.hour%12].x + WATCHFACE_EYE_MIN2_ORIGIN_X; 
	temp_origin_size.origin.y = eye_origin[datetime.hour%12].y + WATCHFACE_EYE_MIN2_ORIGIN_Y; 
