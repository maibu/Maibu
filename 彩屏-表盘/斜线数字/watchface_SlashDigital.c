...
static uint8_t ORIGIN_X[5] = {0, 25, 25, 108, 108};
static uint8_t ORIGIN_Y[5] = {0, 11, 92, 11, 92};
static uint8_t ORIGIN_H[5] = {176, 80, 80, 80, 80};
static uint8_t ORIGIN_W[5] = {176, 55, 55, 55, 55};
