...
static uint8_t ORIGIN_X[5] = {0, 24, 24, 24, 24};
static uint8_t ORIGIN_Y[5] = {0, 19, 42, 82, 105};
static uint8_t ORIGIN_H[5] = {128, 23, 23, 23, 23};
static uint8_t ORIGIN_W[5] = {128, 104, 104, 104, 104};
