...
int32_t bmp_array_name[11] = {
	...
	RES_BITMAP_WATCHFACE_WOW_BG
};

int8_t number_width_array[10] = {14,15,16,16,19,19,15,19,15,17};
...
//hour
	temp_frame.origin.x = 62 - number_width_array[datetime.hour % 10];
	temp_frame.origin.y = 99;
