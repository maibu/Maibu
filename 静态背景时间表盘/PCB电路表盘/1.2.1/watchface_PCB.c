 ...
 * 
 *     Modulename:
 *       Filename:  watchface_RotarySeal.c
 *
 *    Description:  腕上PCB
 *    Corporation:
 * 
...
static uint8_t ORIGIN_X[5] = {0, 25, 43, 68, 86};
static uint8_t ORIGIN_Y[5] = {0, 54, 54, 54, 54};
static uint8_t ORIGIN_H[5] = {128, 20, 20, 20, 20};
static uint8_t ORIGIN_W[5] = {128, 18, 18, 18, 18};
