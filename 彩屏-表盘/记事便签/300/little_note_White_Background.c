...
static uint32_t g_end_seconds		   = 0;//标志记录结束的秒数
...
//时间图层坐标及高宽
#define LITTLE_NOTE_TIME_X 66
#define LITTLE_NOTE_TIME_Y 0
#define LITTLE_NOTE_TIME_H 42
#define LITTLE_NOTE_TIME_W 109

//月日图层坐标及高宽
#define LITTLE_NOTE_MON_DAY_X 6
#define LITTLE_NOTE_MON_DAY_Y 4
#define LITTLE_NOTE_MON_DAY_H 16
#define LITTLE_NOTE_MON_DAY_W 50

//星期图层坐标及高宽
#define LITTLE_NOTE_WEEK_X 6
#define LITTLE_NOTE_WEEK_Y 24
#define LITTLE_NOTE_WEEK_H 16
#define LITTLE_NOTE_WEEK_W 50

//记事框图层坐标及高宽
#define LITTLE_NOTE_LTEXT_X 6
#define LITTLE_NOTE_LTEXT_Y 48
#define LITTLE_NOTE_LTEXT_H 128
#define LITTLE_NOTE_LTEXT_W 164
...
P_Window init_window(void)
{
	...
	/*创建背景图层*/
	//GRect temporary_frame = {{0, 0}, {44, 176}};
	GRect temporary_frame = {{0, 0}, {176, 176}};
	P_GRect temp_p_frame = &temporary_frame;

	display_target_layer(p_window,temp_p_frame,GAlignCenter,GColorWhite,RES_BITMAP_WATCHFACE_LITTLE_NOTE_BG);
	...
	display_target_layerText(p_window,temp_p_frame,GAlignRight,GColorBlack,buffer,U_ASCII_ARIALBD_42,GColorWhite);
	...
	display_target_layerText(p_window,temp_p_frame,GAlignLeft,GColorBlack,buffer,U_ASCII_ARIAL_16,GColorWhite);
	...
	layer1_scroll.font_type = U_GBK_SIMSUNBD_20;
	layer1_scroll.gap = 1;
