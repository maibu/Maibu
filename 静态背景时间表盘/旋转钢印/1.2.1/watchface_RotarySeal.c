...
static uint8_t ORIGIN_X[5] = {0, 1, 30, 70, 99};
static uint8_t ORIGIN_Y[5] = {0, 0, 0, 0, 0};
static uint8_t ORIGIN_H[5] = {128, 128, 128, 128, 128};
static uint8_t ORIGIN_W[5] = {128, 29, 29, 29, 29};
