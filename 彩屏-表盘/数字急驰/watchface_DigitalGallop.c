 ...
 * 
 *     Modulename:
 *       Filename:  watchface_DigitalGallop.c
 *
 *    Description:  数字疾驰表盘
 *    Corporation:
 * 
...
static uint8_t ORIGIN_X[5] = {0, 33, 33, 33, 33};
static uint8_t ORIGIN_Y[5] = {0, 26, 58, 113, 145};
static uint8_t ORIGIN_H[5] = {176, 32, 32, 32, 32};
static uint8_t ORIGIN_W[5] = {176, 143, 143, 143, 143};


/*图片名数组：第一项为背景图片，后面依次为数字0~9图片*/
uint16_t bmp_array[11] = {PIC_0_1, PIC_1_1, PIC_2_1, PIC_3_1, PIC_4_1, PIC_5_1, PIC_6_1, PIC_7_1, PIC_8_1, PIC_9_1, PIC_NO_1};
...
static void app_watch_data()
{
	...
	if (watch_time[0] == 0) watch_time[0] = 10;
