...
static uint8_t ORIGIN_X[5] = {0, 14, 55, 105, 146};
static uint8_t ORIGIN_Y[5] = {0, 64, 64, 64, 64};
static uint8_t ORIGIN_H[5] = {176, 42, 42, 42, 42};
static uint8_t ORIGIN_W[5] = {176, 25, 25, 25, 25};
